...
2. Teachers can  write notice which will be sent to all students in their class.
...
4. Teachers can see all the messages written by students in Inbox.
5. Teachers can  see all the mark given by them to a student through their marks profile and can edit them if necessary.
6. Students can  submit their assignment but once submitted can't be changed later.
7. Students can see marks given to them by teachers in marks section.
8. Student can see the list of all teachers in the portal and can message any of them.
